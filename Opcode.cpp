...
// Initializes all the fields for every instruction in Opcode enum
{
  ...
  myArray[ADDI].name = "addi";  myArray[ADDI].numOps = 3;   myArray[ADDI].rdPos = -1;  myArray[ADDI].rtPos =  0; myArray[ADDI].rsPos =  1;   myArray[ADDI].immPos =  2;  myArray[ADDI].instType = ITYPE; myArray[ADDI].op_field = "001000"; myArray[ADDI].funct_field = "";
